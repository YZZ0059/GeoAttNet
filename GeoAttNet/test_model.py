...
CONFIG = {
    "model_path": os.path.join("GeoAttNet","result", "best_model.pth"),
    "data_files": [
    ...
    "output_dir": os.path.join("GeoAttNet", "prediction_results_frome"), 
...
class MineralPredictor:
    ...
    def predict_region(self, data_array, transform, crs, output_path=None):
        ...
        print(f" {n_patches_h} x {n_patches_w} = {n_patches_h * n_patches_w} patch")
